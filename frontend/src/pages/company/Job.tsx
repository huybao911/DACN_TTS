...
import { getJobs, deleteJob } from "redux/actions/company";
...
import UpdateJob from "pages/company/UpdateJob";
// @mui
...
interface DataUser {
    ...
    salary: keyof IJobEvent;
    jobDescription: keyof IJobEvent;
    jobRequest: keyof IJobEvent;
    benefit: keyof IJobEvent;
    expirationDate: keyof IJobEvent;
    gt: keyof IJobEvent;
    city: keyof IJobEvent;
...
const Job: React.FC = (): JSX.Element => {
    ...
    const sortJobEvent = stableSort(jobs, getComparator(order, orderBy));
    ...
    return (
        ...
        <>
            <Container>
                <Card style={{ padding: "20px", marginTop: "20px", paddingBottom: "40px", borderRadius: "22px", width:"1250px" }}>
                    <StyledRoot
                    ...
                    >
                        ...
                        <Box style={{ display: "flex", flexDirection: "row" }} >
                            ...
                            <Box component={Link} to="/job/newJob" style={{ fontSize: '14px', textDecoration: "none", color: "black" }}>
                                <Box style={{
                    ...
                    <TableContainer>
                        ...
                        <Table >
                            ...
                            {jobs && jobs.length > 0 ? (
                                <TableBody>
                                    {sortJobEvent.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((job: any, index) =>
                                        <TableRow key={job._id}>
                                            ...
                                            <TableCell align="left" sx={{ fontSize: '12px' }}>
                                                <Box style={{ fontSize: '12px', textAlign: "left" }} dangerouslySetInnerHTML={{ __html: job.jobDescription }} />
                                            </TableCell>

                                            <TableCell align="left" sx={{ fontSize: '12px' }}>
                                                <Box style={{ fontSize: '12px', textAlign: "left" }} dangerouslySetInnerHTML={{ __html: job.jobRequest }} />
                                            </TableCell>

                                            <TableCell align="left" sx={{ fontSize: '12px' }}>
                                                <Box style={{ fontSize: '12px', textAlign: "left" }} dangerouslySetInnerHTML={{ __html: job.benefit }} />
                                            </TableCell>
                                            ...
                                            <TableCell align="right">
                                                ...
                                                >
                                                    <Box>
                                                        <UpdateJob job={job} key={job._id} />
                                                    </Box>
                                                </Popover>
                                            </TableCell>
                                            <TableCell >
                                                <Button style={{ color: "red" }} onClick={(e) => dispatch(deleteJob(job._id))} >
